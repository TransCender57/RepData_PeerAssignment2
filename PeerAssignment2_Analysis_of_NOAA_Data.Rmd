...
injuries) and economic events (property damage and crop damage). The total
number of events per year range will be computed and presented.
...
The second helper function selects economic realted fields, filters by year
